									...
									<div class="row">
										<div class="col-sm-12">
											<div class="form-group">
												...
												<input class="form-control" id="recipient_name" name="recipient_name" required="true" size="120" type="text"  />
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-6">    
											<div class="form-group">
												...
												<input class="form-control" id="recipient_phone_number" name="recipient_phone_number" required="true" size="10" type="text" />
											</div>
										</div>
										<div class="col-sm-6">    
											<div class="form-group">
												<label for="recipient_email">Email</label>
												<input type="email" class="form-control" id="recipient_email" name="recipient_email" required="true" placeholder="Enter email"  />
											</div>
										</div>
									</div>
									<div class="row">
        ...
        foreach( $order_items as $item_key => $item ) {
			...
			if ( ! empty( $sku ) AND ! empty( $recipient_email ) ) {
				...
				if ( $result['success'] == 1) {
					...
					$message = '<p>Enjoy your free coupon. Click the link below</p>';
					...
					$message = $client->messages->create(
					  ...
					  array(
						...
						'body' => 'Your friend ' . $display_name . ' has sent you a coupon.  Click this link ' . $passkit_url
					  )
					);
